...
import {USERID,TAG,SELLER_VENDOR_INFO} from '../../../url';
import './url.js'
...
class VendorHome extends React.Component{
  state={isLoading:false,not_found:false,profile_info:[],loading_msg:'Please Wait'}
  ...
  render()
  {
    ...
    if(!not_found)
    {
      ...
      return(<div class="top_div">
              <Header profile_info={profile_info}/>
                  <ToastContainer autoClose={1000}/>
                  <Switch>
                    {routes.map((route, idx) => {
                        return route.component ? (<Route key={idx} path={route.path} exact={route.exact} name={route.name} render={props => (
                            <route.component {...props} profile_info={profile_info}/>
                          )} />)
                          : (null);
                      },
                    )}
