...
class CreateGig extends React.Component
{
  ...
  this.getVendorCategories();
      // $('#basic_pack_name').css("background-color","yellow");
  ...
  _onChange= (event,tag)=>{
    ...
    {
      this.setState({
          img2: event.target.files
      })
    }
    else {
      this.setState({
          img3: event.target.files
      })
    }
    if(this.state.gig_img_count<3)
    {
      this.setState({gig_img_count:this.state.gig_img_count+1});
    }

    // if(event.target.files.length>3)
    // {
    //           toast('Maximum three files are allowed',{ transition: Zoom,});
    //   return false;
    // }
...
// $('#gig_video_upload_1').attr('src',dataURI);
// }
    getLanguageList=()=>{
      axios.get(GETLANGUAGELIST).then((res)=>{
        if(res.data.success==1)
        {
          this.setState({language:res.data.data,isLoading:true});
        }
        else {
    ...
    getVendorCategories=()=>{
      axios.post(GETVENDORSERVICECATEGORY,{'user_id':localStorage.getItem('user_id'),'tag':TAG},VENDOR_HEADER).then((res)=>{
        if(res.data.success==1)
        {
...
// var val_arr=['gig_upload_1','gig_upload_2','gig_upload_3','gig_video_upload','gig_title',
// 'category',
// 'basic_pack_name',
// 'standard_pack_name',
// 'premium_pack_name',
...
// 'gig_keywords',
// 'basic_pack_delivery',
// 'standard_pack_delivery',
// 'premium_pack_delivery',
// 'basic_pack_revision',
// 'standard_pack_revision',
// 'premium_pack_revision',
// 'basic_pack_price',
// 'standard_pack_price',
// 'premium_pack_price'];
...
//   if(val_arr[i]=='')
//   {
//     $('#'+val_arr[i]).addClass('alidation_error')
//   }
// }
// return false;
    ...
    axios.post(CREATEVENDORGIG,formData,VENDOR_HEADER)
    .then(response=>{
