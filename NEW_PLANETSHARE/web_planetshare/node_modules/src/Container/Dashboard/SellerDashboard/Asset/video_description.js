...
import $ from 'jquery';
import {USERID,TOKEN,HEADER,TAG,GETSELLERFORMDATA,SELLERVIDEOUPLOADDESCRIPTION,GETFORMSTATUS} from '../../../../url.js'
...
state={err_result:[],imgs:[],video_id:0,language:[],loading:false,loading_msg:'Please Wait',not_found:false,lang_sel:[],director:[],producer:[],genre:[],cast:[],keywords:[],btn_disable:false,category_list:[],license_rights:[],sel_license_rights:[],territory_rights:[],sel_territory_rights:[]}
  componentDidMount()
  {
...
this.setState({video_id:this.props.match.params.video_id,loading:false},function()
  ...
  render() {
    const {loading,loading_msg,not_found,language,keywords,cast,producer,director,category_list,err_result}=this.state;
    if(not_found)
    {
      return(<Not_Found/>)
    }
