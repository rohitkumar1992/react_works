...
import {GETVIDEODATA,TAG,ADDTOCOLLECTION,CREATECOLLECTION,DOWNLOADS,GETPACKS} from '../../url';
import $ from 'jquery'
                            ...
                            <form onSubmit={this.buyPack}>
                              <div class="plan_area">
                                <div class="user_name">
                                    ...
                                    <p>It's simple. Your video will start downloading once you choose your plan. Our worry-free standard license covers the most common use of this image.</p>
                                </div>
                                {singlePack.length>0  && <h4>Single video</h4>}
                                {singlePack.length>0 && <p class="t">Save with an annual plan, charged monthly.</p>}
