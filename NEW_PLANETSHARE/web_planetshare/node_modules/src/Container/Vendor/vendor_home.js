...
componentDidMount()
{
  localStorage.setItem('url','/dashboard/vendor')
}
  render()
  {
              ...
              <source src= "https://res.cloudinary.com/deyonsykf/video/upload/v1578631650/partner1_r1cuqt.webm" type="video/webm"/>
                  ...
                  <div class="caption">
                      <div class="container">
                          ...
                          <div class="buttons">
                              <Link to="/dashboard/vendor"><button type="button" class="btndefault">{localStorage.getItem('vendor_id')==0?"Become a Vendor":"Go To Dashboard"}</button></Link>
                          </div>
                      </div>
          ...
          <section class="inner_cont vndr_page">
                          ...
                          <div class="row">
                              <div class="col col-md-6">
                                  <div class="box">
                                      ...
                                      <p>Discover what it takes to be a top-notch seller on Fiverr with this complimentary Learn from Fiverr course.</p>
                                      <Link to="/dashboard/vendor"><button type="button" class="btndefault">Register</button></Link>
                                  </div>
                              </div>
                              <div class="col col-md-6">
                                  <div class="box">
              ...
              <div class="vend_started">
                  <div class="container">
                      ...
                      <Link to="/dashboard/vendor"><button class="btndefault" type="button">Get Started</button></Link>
                  </div>
                  <div class="clearfix"></div>
              </div>
              <div class="clearfix"></div>
...
export default withLastLocation(ImageCategoryData);
