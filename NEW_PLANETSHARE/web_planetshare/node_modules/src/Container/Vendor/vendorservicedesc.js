...
class ViewServiceDesc extends React.Component{
  state={isLoading:true,gig_id:'',gig_desc:{},vendor_desc:{},more_service_by_c_vendor:[],not_found:false,loading_msg:'Please Wait'}
  componentDidMount()
  {
    // var lastId,
...
ScrollTo=(scroll_id)=>{
  ...
  render()
  {
    const {isLoading,not_found,gig_desc,vendor_desc,more_service_by_c_vendor,loading_msg}=this.state;
      ...
      return( <div class="cat_item" key={key}>
              <div class="box">
                <Link to={`/web/vendorservice_description/${result.vendor_service_gigs_id}/${result.id}`}>
                    ...
                    <div class="sell_info">
                        <a href="javascript:"><img src={result.get_profile_picture.profile_pic} alt="" />{result.vendor_name}</a>
                    </div>
                    <div class="desc">
                        <a href="javascript:">{result.gig_title}</a>
                    </div>
                    <div class="review">
                        <div class="rating">
                          ...
                          <nav>
                              ...
                              <div class="actions">
                                  ...
                                  <div class="share_link">
                                      <button type="button"><i class="fa fa-share-alt" aria-hidden="true"></i> Share</button>
                                  </div>
                              </div>
                          </nav>
                      </article>
