...
class Aboutus extends React.Component{
  ...
  componentDidMount(){
    this.setState({url_id:this.props.match.params.id_name},function(){this.ScrollTo()});
    // $(function() {
  ...
  ScrollTo=()=>{
    var myEle = document.getElementById(this.state.url_id);
    if(myEle)
    {
    $('html, body').animate({
  ...
  componentDidUpdate()
  {
    if(this.props.match.params.id_name!=this.state.url_id)
    {
        this.setState({url_id:this.props.match.params.id_name},function(){this.ScrollTo()});
    }
  }
