                            ...
                            <div class="cont_desc drl">
                                <div class="box l">
                                    <div class="desc">
                                        ...
                                        <div class="buttons">
                                            <a href="javascript:" class="btndefault"><i class="fa fa-cogs"></i> Check out our tools for Phrase and Lip-Synch <i class="fa fa-angle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box r">
                                ...
                                <div class="box l">
                                    <div class="desc">
                                        ...
                                        <div class="buttons quote">
                                            <a href="javascript:" class="btndefault">Quote <i class="fa fa-angle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box r">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="box r wow fadeInUp">
                                    ...
                                    <div class="buttons">
                                        <a href="javascript:" class="btndefault">Go to Subtitling <i class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="work_top_cont">
                        ...
                        <div class="box r">
                            <div class="desc">
                                ...
                                <div class="buttons">
                                    <a href="javascript:" class="btndefault"><i class="fa fa-angle-down"></i> Here is a step by step guide on a typical project process...</a>
                                </div>
                            </div>
                        </div>
                    </div>
