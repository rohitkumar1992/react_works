...
const routes = [
  ...
  //  { path:'/home/:id',exact:true,name: 'Home',  component: HOME },
   ...
   {path:'/kog_search/search_keyword=/kog@521/:word' ,exact:true,name:'Search',component:SEARCH_PAGE},
   ...
   { path:'/playlist/:name/:id',exact:true,name: 'Playlist',  component: PLAYLIST_VIDEOS },
    { path:'/kog_user/profile/:user_id',exact:true,name: 'UserProfile',  component: USER_PROFILE },
