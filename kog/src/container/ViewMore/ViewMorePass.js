                  ...
                  <article class="container">
                      <div class="horz_cat cat_slides">
                          ...
                          <div class="row">
                            ...
                            {<Link to={res.sub_count==null?`/cat/${route_name}/${(res.Parent_name.replace(/\s/g,'_')).toLowerCase()}/${res.Parent_id}`:`/season/${(res.Parent_name.replace(/\s/g,'')).toLowerCase()}/${res.Parent_id}`} class="box">
                              <div class="img">
