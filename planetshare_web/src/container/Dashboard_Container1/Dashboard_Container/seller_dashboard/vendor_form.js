...
import {CHECK_VENDOR_STATUS} from '../../../url';
...
return(
    ...
    <div className='step-progress'>
           <StepZilla steps={steps} stepsNavigation={true} prevBtn={false} startAtStep={0}/>
       </div>
       </div></center>
     )}
...
return(
   <center><div style={{marginTop:'80px'}}>
   <div className='step-progress'>
          <StepZilla steps={steps} stepsNavigation={true} prevBtn={false} startAtStep={1}/>
      </div>
      </div></center>
    )}
...
return(
  <center><div style={{marginTop:'80px'}}>
  <div className='step-progress'>
         <StepZilla steps={steps} stepsNavigation={true} prevBtn={false} startAtStep={2}/>
     </div>
     </div></center>
   )}
   }
