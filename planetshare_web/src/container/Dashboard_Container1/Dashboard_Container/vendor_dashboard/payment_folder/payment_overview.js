      ...
      return (<div class="col-xl-4 col-md-4 mb-4 top_div" style={{marginTop:'50px'}}>
                              ...
                              <div style={{fontSize:'18px',color:'black',padding:'15px'}}>{result.head}</div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="row"><div class="col-md-6"  style={{fontSize:'15px',color:'rgba(0,0,0,0.6)'}}>Total</div><div class="col-md-6"  style={{fontSize:'15px',color:'red'}}>{result.price}&nbsp;(In Rupees)</div></div>
