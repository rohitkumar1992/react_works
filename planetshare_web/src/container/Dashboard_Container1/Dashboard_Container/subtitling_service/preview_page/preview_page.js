                              ...
                              <div class="row">
                                  <div class="col-md-3" >
                                      ...
                                      {video_details.payment_id==null?<Link to={{
                                        ...
                                        <div style={{color:'black'}}><h4 class="">Download Url</h4>{download_link.map((output,key)=>{
                                          return(  <div><button class="btn btn-primary btn-md " onClick={this.downloadVideo.bind(this,video_details.id,video_details.file_name)}>Download in {output}</button>
                                                  </div>);
                                        })}</div>
                                    }
