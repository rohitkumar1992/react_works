    ...
    <center><div style={{marginTop:'80px'}}>
       <div class="main">
        <div class=" mt-5">
         ...
         <label for="country_name" id="lab">Country Name:</label></div>
          <div class="col-lg-12 col-md-12 col-sm-12 text-left"  >
         ...
         <div class="form-group input_4">
          <div class="col-lg-12 col-md-12 col-sm-12 text-left"  >
         <label for="pincode" id="lab" >Pincode</label></div>
          <div class="col-lg-12 col-md-12 col-sm-12 text-left"  >
         <input type="text" class="form-control input_1" id="pincode"  name="pincode" required/>
                ...
                <div class="form-group input_4">
                 <div class="col-lg-12 col-md-12 col-sm-12 text-left"  >
                <label for="city" id="lab" >City</label></div>
                 <div class="col-lg-12 col-md-12 col-sm-12 text-left"  >
                ...
                <div class="ff">
                 <div class="col-lg-12 col-md-12 col-sm-12 text-left" >
                <label for="address" id="lab" name="address">Address</label></div>
                    <div class="col-lg-12 col-md-12 col-sm-12 text-left"  >
                 <textarea rows="4" cols="50" id="address">
                </textarea>
                </div>  </div>
                </div>
                <button type="submit" class="btn btn-prev btn-primary btn-lg pull-right" id="next-button1">Submit</button>
          </div>
         </div>
