...
dubbingList=(e)=>{
  ...
  render() {
    ...
    return (
      ...
      <div class="row">
      <div class="col-md-6 col-lg-8 col-sm-10 col_sub" >
...
<td>
       ...
       <td class="yy">  <input type="number" className="price_box"  name="pp" id="price0" placeholder="Enter Price"  required/></td>
       <td>Per Minute</td>
      </tr>
        ...
        <button type="submit" class="btn btn-lg btn-success pull-right vender_next_btn" id="save_button">Next</button>
      </form>
