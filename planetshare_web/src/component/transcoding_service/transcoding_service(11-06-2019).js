...
<div class="banner_information">
  ...
  <h1>HOW ITS WORK</h1>
  <img src="img/transcoding_flow.png" />
  ...
  <p id="trans_para3">Running cost <span style={{marginLeft:'100px'}}>Rs&nbsp;250 &nbsp;(Per Minute)</span></p>
     ...
     <div class="row ">
      ...
      <video playsinline="playsinline"  muted="muted" loop="loop" controls style={{width:'100%'}}>
     ...
     <div class="row ml-3">
       <div class="col-sm-12 col-md-12 col-lg-6 ">
         <ul class="features_transcoding ">
          <li><i class='fa fa-caret-right caret mr-2'></i> <span id="span_text"> Superior quality and fast turnaround </span> </li>
          <li><i class='fa fa-caret-right caret mr-2'></i> <span id="span_text">Integration into your existing content management system </span></li>
          <li> <i class='fa fa-caret-right caret mr-2'></i><span id="span_text">Support for all major streaming formats </span> </li>
          <li> <i class='fa fa-caret-right caret mr-2'></i><span id="span_text">High Performance   </span> </li>
          <li><i class='fa fa-caret-right caret mr-2'></i><span id="span_text"> Scalability </span></li>

          <li><i class='fa fa-caret-right caret mr-2'></i><span id="span_text"> Reliability  </span></li>
        </ul>
     </div>
