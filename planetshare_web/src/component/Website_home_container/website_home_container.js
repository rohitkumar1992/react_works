          ...
          <div class="container">
            <div class="market_area">
              <div class="side_cat">
                ...
                <ul>
                  <li><Link to="/web/category/business">Business</Link></li>
                  <li><Link to="/web/category/fashion">Fashion</Link></li>
                  <li><Link to="/web/category/healthcare">Healthcare</Link></li>
                  <li><Link to="/web/category/wildlife">Wildlife</Link></li>
                  <li><Link to="/web/category/food&drink">Food & Drink</Link></li>
                  <li><Link to="/web/category/education">Education</Link></li>
                  <li><Link to="/web/category/science">Science</Link></li>
                  <li><Link to="/web/category/finance">Finance</Link></li>
                  <li><Link to="/web/category/sports">Sports</Link></li>
