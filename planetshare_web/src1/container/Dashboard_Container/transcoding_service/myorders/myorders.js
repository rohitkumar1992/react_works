  ...
  render()
  {
    const table=(this.state.myorders==''?<tr class="table_content"><td colspan="5" class="width_set">No Records Found</td></tr>:this.state.myorders.map((result,key)=>{
      return (<tr class="table_content">
                {/*<td class="width_set"><center><img src={`http://192.168.24.132/${result.thumbnail}`} class="table_img"/></center></td>*/}
                <td class="width_set">{result.transcode_id}</td>
                <td class="width_set">{result.preset}</td>
    ...
    return(
      <div class="transcoding_myorder" style={{marginTop:'20px'}}>
      <div class="row" >
