...
import {VENDOR_SERVICE_COUNT} from '../../../../url.js';
  ...
  <body>
    <div class="container-scroller">
      <div class="page-body-wrapper" style={{backgroundColor:'white'}}>
         ...
         <p >Please Add The Services</p>
      <Link to="/dashboard/vendor/addservice"><button  type="button"style={{cursor:'pointer'}}  class="btn btn-lg btn-primary" >Add Service Now</button></Link>
         </div>
