...
this.setState({ selectedPriority:selectedOption });
  ...
  render() {
    ...
    <li><input type="checkbox" name="areaofinterest" value="English" id="home_coo" class="Checkbox" /> English</li>
    <li><input type="checkbox" name="areaofinterest" value="Hindi" id="home_cra" class="Checkbox"/> Hindi</li>
    <li><input type="checkbox" name="areaofinterest" value="Bengali" id="home_dec" class="Checkbox"/> Bengali</li>
    <li><input type="checkbox" name="areaofinterest" value="Tamil" id="home_ent" class="Checkbox"/> Tamil</li>
    <li><input type="checkbox" name="areaofinterest" value="Telugu" id="home_gar" class="Checkbox"/> Telugu</li>
    <li><input type="checkbox" name="areaofinterest" value="Chinese" id="home_hom" class="Checkbox"/>Chinese</li>
    <li><input type="checkbox" name="areaofinterest" value="Russian" id="home_mar" class="Checkbox"/> Russian</li>
    <li><input type="checkbox" name="areaofinterest" value="Arabic" id="home_par" class="Checkbox"/> Arabic</li>
    <li><input type="checkbox" name="areaofinterest" value="Korean" id="home_pet" class="Checkbox" /> Korean</li>
    <li><input type="checkbox" name="areaofinterest" value="Urdu" id="home_ret" class="Checkbox"/> Urdu</li></ul>
...
<label for="output_div">Output Format</label>
              <Select
                 ...
                 id="output_div"
                 />
                    <label for="notification_div">Notification</label>
                    <Select
              ...
              <center><button type="submit" class="btn btn-lg btn-success " id="save_button" style={{marginLeft:'100px'}}>Next</button></center>
              </form>
              </div>}
            </div>
        )
