            ...
            <ToastContainer autoClose={2000}/>
              ...
              <form  id="form_tag"  action="javascript:" onSubmit={this.formSubmitHandler}>
               ...
               <div class="col-sm-10 col-lg-4 col-md-6 col_css" style={{marginTop:'0px',marginLeft:'33%'}}>
                    ...
                    <input type="text"  list="original_lang_list" class="form-control form-control-sm form-control-sm1 width_6" name="original_language" id="original_language"/>
                    <datalist id="original_lang_list">
                    ...
                    <Select
                       ...
                       id="notification_div"
                       />
                       <button type="submit" class="btn btn-md btn-primary pull-right mt-4" id="save_button">Next</button>
              </div>
              </div>
