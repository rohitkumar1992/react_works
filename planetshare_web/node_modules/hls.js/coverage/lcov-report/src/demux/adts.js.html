...
<span class="cstat-no" title="statement not covered" >  if (!track.samplerate) {</span>
    var config = <span class="cstat-no" title="statement not covered" >getAudioConfig(observer, data, offset, audioCodec);</span>
...
export function <span class="fstat-no" title="function not covered" >appendFrame(</span>track, data, offset, pts, frameIndex) {
  var frameDuration = <span class="cstat-no" title="statement not covered" >getFrameDuration(track.samplerate);</span>
  var header = <span class="cstat-no" title="statement not covered" >parseFrameHeader(data, offset, pts, frameIndex, frameDuration);</span>
<span class="cstat-no" title="statement not covered" >  if (header) {</span>
    var stamp = <span class="cstat-no" title="statement not covered" >header.stamp;</span>
    var headerLength = <span class="cstat-no" title="statement not covered" >header.headerLength;</span>
    var frameLength = <span class="cstat-no" title="statement not covered" >header.frameLength;</span>
&nbsp;
    //logger.log(`AAC frame, offset/length/total/pts:${offset+headerLength}/${frameLength}/${data.byteLength}/${(stamp/90).toFixed(0)}`);
    var aacSample = <span class="cstat-no" title="statement not covered" >{</span>
