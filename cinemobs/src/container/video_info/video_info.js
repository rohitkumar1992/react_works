...
import {VIDEO_DATA,RELATED_VIDEO,PLAYLIST,COUNTRYCODE,PARTNER_ID,CONTINUE_WATCHING,FAVOURITES,WATCHLATER,USER_HISTORY,PLAYLIST_VIEW} from '../../url'
   ...
   getData=async ()=>{
    ...
    let response= await axios.post(VIDEO_DATA,formData,{headers:{'token':localStorage.getItem('token')}});
      ...
      continue_watching=async ()=>{
        ...
        {
          toast('Please Do Login First',{ transition: Zoom,});
          return false;
        }
        var formData=new FormData();
        formData.append('userid',localStorage.getItem('userid'));
                      ...
                      <div class="row">
                        <div class="col-md-7 col-lg-8">
                          ...
                          <div class="view_info">
                              <div class="ttl_info">
                                  <div class="row">
                                      ...
                                      <div class="col-md-12 col-lg-4">
                                          <ul class="icon_list">
                                              <li><a href="javascript:;" onClick={()=>this.likeDislike('L')}><i class="fa fa-hand-o-up" aria-hidden="true"  style={{color:(response_data.userlike=='L' && response_data.userlike!=='D')?'#9012cd':''}}></i>{response_data.totallike=='None'?0:response_data.totallike}</a></li>
                                              <li><a href="javascript:;" onClick={()=>this.likeDislike('D')}><i class="fa fa-thumbs-o-down" aria-hidden="true"  style={{color:(response_data.userlike=='D' && response_data.userlike!=='L')?'#9012cd':''}}></i>{response_data.totaldislike=='None'?0:response_data.totaldislike}</a></li>
                              ...
                              <div class="desc">
                                  <h4>Description</h4>
                                  <p>{response_data.longdescription.substr(0,400)}</p>
                                  <div class="clearfix"></div>
                              </div>
                              <div class="clearfix"></div>
                          </div>
